  ...
  return (
    <section className='max-w-7xl max-auto' >
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>Browse through a collection of imaginations and visually  generated by DALL-E AI </p>
      </div>
      <div className='mt-16'>
        <FormField 
        ...
        {loading ? (
          ...
          <>
            ...
            <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
              {searchText ? (
                <RenderCard data= {searchResult} title="No search result found" />
              ) : (
                <RenderCard data={post} title = " No posts found" />
              )}
            </div>
